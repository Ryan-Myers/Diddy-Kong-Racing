...
f32 D_800DC8AC[27] = { 50.0f,  0.0f,   32.0f,  -50.0f, 0.0f, 32.0f, -50.0f, 100.0f,  32.0f,  0.0f,   0.0f,    32.0f, 130.0f, 60.0f,
                       -68.0f, 130.0f, -60.0f, -68.0f, 0.0f, 0.0f,  32.0f,  -130.0f, -60.0f, -68.0f, -130.0f, 60.0f, -68.0f };
...
s32 func_80029DE0(Object *obj, s32 segmentIndex) {
    ...
    if ((x < (bb->unk6 + 25)) && ((bb->unk0 - 25) < x) && (z < (bb->unkA + 25)) && ((bb->unk4 - 25) < z) && (y < (bb->unk8 + 25)) &&
        ((bb->unk2 - 25) < y)) {
        return TRUE;
    }
...
s32 func_8002A134(s32 *arg0, s16 arg1, s16 arg2, s16 arg3, s16 arg4, s16 arg5, s16 arg6) {
    ...
    while (i < gCurrentLevelModel->numberOfSegments) {
        bb = &gCurrentLevelModel->segmentsBoundingBoxes[i];
        if ((bb->unk6 >= arg1) && (arg4 >= bb->unk0) && (bb->unkA >= arg3) && (arg6 >= bb->unk4) && (bb->unk8 >= arg2) &&
            (arg5 >= bb->unk2)) {
            phi_v1++;
            *arg0++ = i;
        }

...
#define DEFAULT_VIEWPORT                                                                                                           \
    0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_WIDTH_HALF, SCREEN_HEIGHT_HALF, SCREEN_WIDTH, SCREEN_HEIGHT, 0, 0, SCREEN_WIDTH - 1, \
        SCREEN_HEIGHT - 1, 0
...
s16 D_800DD138[8] = { 0, 0, 0, -1, -1, 0, 0, 0 };

// RSP Viewports
Vp D_800DD148[20] = {
    { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 },
    { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 },
    { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 },
    { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 },
    { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 },
    { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 },
    { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 }, { 0, 0, 0x01FF, 0, 0, 0, 0x01FF, 0 },
};
...
u8 D_800DD2F8[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
void func_80066CDC(Gfx **dlist, s32 arg1) {
    ...
    if (gScreenViewports[D_80120CE4].flags & 1) {
        gDPSetScissor((*dlist)++, SCISSOR_INTERLACE, gScreenViewports[D_80120CE4].upperLeftX,
                      gScreenViewports[D_80120CE4].upperLeftY, gScreenViewports[D_80120CE4].lowerRightX,
    ...
    switch (gNumberOfViewports) {
        ...
        case VIEWPORTS_COUNT_4_PLAYERS:
            ...
            switch (D_80120CE4) {
                case 0:
                    gDPSetScissor((*dlist)++, SCISSOR_INTERLACE, 0.0f, 0.0f, (temp_a2 - (temp_t1 >> 8)),
                                  (temp_a3 - (temp_t0 >> 7)));
                    phi_t5 = 0;
                    phi_t4 = 0;
                case 1:
                    gDPSetScissor((*dlist)++, SCISSOR_INTERLACE, (temp_a2 + (temp_t1 >> 8)), 0, ((temp_a2 * 2) - (temp_t1 >> 8)),
                                  (temp_a3 - (temp_t0 >> 7)));
                    phi_t5 = 0;
                    phi_t4 = temp_a2;
                    break;
                case 2:
                    gDPSetScissor((*dlist)++, SCISSOR_INTERLACE, 0, temp_a3 + (temp_t0 >> 7), temp_a2 - (temp_t1 >> 8),
                                  (temp_a3 * 2) - (temp_t0 >> 7));
                    phi_t5 = temp_a3;
                    phi_t4 = 0;
                    break;

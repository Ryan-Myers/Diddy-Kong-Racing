...
void func_80031BB8(s32 count) {
    ...
    func_80031B60();
    D_800DC958 = count;
    D_800DC950 = allocate_from_main_pool_safe(
        D_800DC958 * (sizeof(s32 *) + sizeof(unk800DC954) + sizeof(unk800DC960) + sizeof(unk800DC964)), COLOR_TAG_MAGENTA);
...
void func_80032C7C(Object *object) {
    ...
    if (object->descriptor_ptr->unk3D == 0) {
        ...
        for (i = 0; i < D_800DC95C; i++) {
            entry = D_800DC950[i];
            if ((entry->unk2 & sp64) && (entry->unk4 == 1) && (sp82 >= entry->unk50) && (entry->unk56 >= sp82) &&
...
f32 func_80033A14(unk800DC950 *arg0) {
    ...
    switch (arg0->unk3) {
        ...
        case 2:
            ...
            break;
        case 3:
            temp = func_800707F8(sqrtf(D_8011D4C0) * arg0->unk6C * 16384.0f);
            out *= temp;
            break;
        case 4:
            temp = func_800707F8(sqrtf(D_8011D4C0) * arg0->unk6C * 16384.0f);
...
f32 func_80033C08(unk800DC950 *arg0) {
    ...
    if (phi_f12 > 0.0f) {
        ...
        phi_f12 =
            (D_8011D4C4 * temp_f2 * arg0->unk7C) + (D_8011D4C8 * temp_f2 * arg0->unk80) + (D_8011D4CC * temp_f2 * arg0->unk84);
        if (phi_f12 < 0.0f) {
            phi_f12 = 0.0f;
        }
    } else {

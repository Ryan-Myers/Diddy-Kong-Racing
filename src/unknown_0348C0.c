...
u16 D_800DC970[4] = { 0x40FF, 0xFFFF, 0x0007, 0x0003 };
u16 D_800DC978[4] = { 0x0000, 0x0000, 0x001E, 0xFFFF };
u16 D_800DC980[20] = { 0xFF00, 0x0100, 0x0000, 0xFFFF, 0xFFFF, 0x0100, 0x0100, 0x0000, 0xFFFF, 0xFFFF,
                       0x0100, 0xFF00, 0x0000, 0xFFFF, 0xFFFF, 0xFF00, 0xFF00, 0x0000, 0xFFFF, 0xFFFF };
u16 D_800DC9A8[20] = { 0x0000, 0x0040, 0xFFC0, 0x0000, 0xFFC0, 0xFFC0, 0x0000, 0x0040, 0x0020, 0x0000,
                       0xFFC0, 0x0020, 0x0000, 0x0040, 0x0040, 0x0000, 0xFFC0, 0x0040, 0x0000, 0x0000 };
u16 D_800DC9D0[64] = { 0x0000, 0x0301, 0x0004, 0x0000, 0x0001, 0x0004, 0x0004, 0x0004, 0x0000, 0x0203, 0x0004, 0x0000, 0x0001,
                       0x0000, 0x0001, 0x0004, 0x0002, 0x0503, 0x0001, 0x0000, 0x0000, 0x0004, 0x0001, 0x0004, 0x0002, 0x0405,
                       0x0001, 0x0000, 0x0000, 0x0000, 0x0000, 0x0004, 0x0000, 0x0103, 0x0004, 0x0000, 0x0004, 0x0004, 0x0001,
                       0x0004, 0x0000, 0x0302, 0x0004, 0x0000, 0x0001, 0x0004, 0x0001, 0x0000, 0x0002, 0x0305, 0x0001, 0x0000,
                       0x0001, 0x0004, 0x0000, 0x0004, 0x0002, 0x0504, 0x0001, 0x0000, 0x0000, 0x0004, 0x0000, 0x0000 };
s8 D_800DCA50[8] = { 2, 5, 6, 3, 10, 8, 7, 9 };
u8 D_800DCA58[9] = { 2, 5, 6, 3, 10, 8, 7, 9, 11 };
s8 D_800DCA64[9] = { 2, 5, 6, 3, 10, 8, 7, 9, 12 };
s8 D_800DCA70[10] = { 2, 5, 6, 3, 10, 8, 7, 9, 11, 12 };
...
u16 D_800DCAA8[64] = { 0x0000, 0x0301, 0x0000, 0x0000, 0xFFFF, 0xFFFF, 0x0000, 0xFFFF, 0x0000, 0x0203, 0x0000, 0x0000, 0xFFFF,
                       0x0000, 0xFFFF, 0xFFFF, 0x0002, 0x0503, 0xFFFF, 0x0000, 0x0000, 0xFFFF, 0xFFFF, 0xFFFF, 0x0002, 0x0405,
                       0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0103, 0x0000, 0x0000, 0x0000, 0xFFFF, 0xFFFF,
                       0xFFFF, 0x0000, 0x0302, 0x0000, 0x0000, 0xFFFF, 0xFFFF, 0xFFFF, 0x0000, 0x0002, 0x0305, 0xFFFF, 0x0000,
                       0xFFFF, 0xFFFF, 0x0000, 0xFFFF, 0x0002, 0x0504, 0xFFFF, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000 };
u16 D_800DCB28[20] = { 0xFFC0, 0x0000, 0x0020, 0xFFC0, 0x0000, 0xFFE0, 0x0000, 0x0000, 0x0020, 0x0000,
                       0x0000, 0xFFE0, 0x0040, 0x0000, 0x0020, 0x0040, 0x0000, 0xFFE0, 0x0000, 0x0000 };
...
void func_80038710(Object *obj, s32 arg1) {
    ...
    if (temp_v0 == 0) {
        ...
        if (phi_v1) {
            func_80066488(obj64->unk30, obj->x_position, obj->y_position, obj->z_position, 0x8000 - obj->y_rotation,
                          -obj->x_rotation, obj->z_rotation);
        }
    }
}
...
void func_8003FEF4(Object *arg0, LevelObjectEntry8003FEF4 *arg1) {
    ...
    func_800098A4(obj64->unk0, obj64->unk2, arg1->common.x, arg1->common.y, arg1->common.z, obj64->unkF, obj64->unkE, obj64->unk10,
                  obj64->unk12, obj64->unk4, obj64->unk11, obj64->unkC, obj64->unkD);
    gParticlePtrList_addObject(arg0);
}

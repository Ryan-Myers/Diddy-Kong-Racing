...
f32 D_800DC76C[15] = { 1.0f,  0.70711f,  0.70711f,  1.0f,  0.0f, 0.70711f,  -0.70711f, 0.0f,
                       -1.0f, -0.70711f, -0.70711f, -1.0f, 0.0f, -0.70711f, 0.70711f };

u16 D_800DC7A8[8] = { 0x0001, 0x0002, 0x0003, 0x0004, 0x0051, 0x0054, 0x0055, 0x0056 };

s16 D_800DC7B8[52] = { 0x00ED, 0x00FF, 0x0037, 0x0038, 0x0039, 0x003A, 0x0057, 0x0058, 0x0059, 0x005A, 0x00F3, 0x00FD, 0x0042,
                       0x0043, 0x0044, 0x0045, 0x005B, 0x005C, 0x005D, 0x005E, 0x00F4, 0x0101, 0x0001, 0x0002, 0x0003, 0x0004,
                       0x0051, 0x0054, 0x0055, 0x0056, 0x00ED, 0x00FF, 0x0001, 0x0002, 0x0003, 0x0004, 0x0051, 0x0054, 0x0055,
                       0x0056, 0x00ED, 0x00FF, 0x00D9, 0x00DF, 0x00E0, 0x0105, 0x008A, 0x00DA, 0x00E8, 0x0115, 0x0118, 0x0000 };

s16 D_800DC820[16] = { 0x0005, 0x0106, 0x0207, 0x0005, 0x0106, 0x010B, 0x010B, 0x0207,
                       0x000C, 0x020D, 0x0101, 0x0101, 0x0101, 0x0101, 0x0101, 0x0000 };
...
#else
void func_80011960(Object *arg0, s32 arg2, u32 arg3, Object_64 *arg4, u32 arg5, u32 arg6, u32 arg7, u32 arg8, f32 arg9) {
}
#endif
    ...
    switch (this->unk48) {
        case 47:
            ...
            if (this->unk7C.word < 0)
                break;
            func_80011960(this, this->unk64->unk20, 4, this->unk64, 2, this->unk64->unk24, 11, 0, 1.0f);
            break;
...
void func_8001E36C(s32 arg0, f32 *arg1, f32 *arg2, f32 *arg3) {
    ...
    *arg3 = -32000.0f;
    for (i = 0; i < objCount; i++) {
        ...
        if (current_obj != NULL && (current_obj->unk6 & 0x8000) == 0 && current_obj->unk48 == 39 && current_obj->unk78 == arg0) {

...
As of March 9, 2025, this is our current score:

&emsp;&emsp;&emsp;&emsp;Decomp progress: 74.23%
...
```
 ...
 --------- 74.23% Complete (76.72% NON_MATCHING) ----------
                # Decompiled functions: 1822
                # GLOBAL_ASM remaining: 119
                # NON_MATCHING functions: 14
             # NON_EQUIVALENT WIP functions: 41
 ---------------------- Game Status -----------------------
         Balloons: 35/47, Keys: 4/4, Trophies: 3/5
           T.T. Amulets: 3/4, Wizpig Amulets: 3/4
 ----------------------------------------------------------
 We are collecting bananas in Smokey Castle. (9/10 Bananas)
 ==========================================================
